...
SECRET_KEY = "django-insecure-8a$n@x^t21%s(6j_ihx4t5#qd-q58(u&t*tt245etezqu*%zr("
...
CORS_ALLOWED_ORIGINS = [
    "http://localhost:3000",  # Your frontend application origin
]
